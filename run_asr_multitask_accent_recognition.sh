...
##  If you want to run an experiment with 8K data, you just need to uncomment the following three lines and start from step 2
...
if [ ! -z $step02 ]; then
   ...
   compute-cmvn-stats scp:$data/${train_set}/feats.scp $data/${train_set}/cmvn.ark
   echo "step02 Extracting filter-bank features and cmvn Done"
fi
...
if [ ! -z $step03 ]; then
   ...
   echo "step03 Generate label file and dump features for track2:E2E Done"   
fi
...
if [ ! -z $step04 ]; then
   echo "stage 04: Dictionary Preparation" 
   ...
   echo "stage 04: Dictionary Preparation Done"
fi
